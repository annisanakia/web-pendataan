...
class Collection_data extends RESTful {
    ...
    public function previewImport()
    {
        ...
        $with['datas'] = array_slice($excel[0], 20, count($excel[0]));
        if($groups_id != 2){
            $with['datas'] = array_slice($excel[0], 22, count($excel[0]));
        }
    ...
    public function storeImport()
    {
        ...
        $volunteer_data_id = is_array(request()->volunteer_data_id)? request()->volunteer_data_id : [];
        ...
        if ($validation->errors()->count() <= 0) {
            ...
            foreach($niks as $key => $nik){
                ...
                $input['rt'] = $rt[$key];
                $input['volunteer_data_id'] = $volunteer_data_id[$key];
