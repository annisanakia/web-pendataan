...
Route::group(['prefix' => 'collection_data', 'namespace' => 'App\Modules\Collection_data\Controllers', 'middleware' => ['web']], function () {
    ...
    Route::get('/updateStatusShare/{id}', ['as' => 'collection_data.updateStatusShare', 'uses' => 'Collection_data@updateStatusShare']);
    Route::get('/updateStatusShareFixed/{id}', ['as' => 'collection_data.updateStatusShareFixed', 'uses' => 'Collection_data@updateStatusShareFixed']);
