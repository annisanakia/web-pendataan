        ...
        <table class="table table-striped mt-3">
            <thead>
                <tr>
                    ...
                    <th class="text-center order-link {{ ($sort_field == 'user_name'? 'sort-'.(orders()[$sort_type] ?? null) : null) }}" href="{{ url($controller_name.'/getData?sort_field=user_name&sort_type='.($sort_field == 'user_name'? $sort_type : 0)+1) }}">
                        Nama Koordinator
                    </th>
                    <th class="text-center order-link {{ ($sort_field == 'district_name'? 'sort-'.(orders()[$sort_type] ?? null) : null) }}" href="{{ url($controller_name.'/getData?sort_field=district_name&sort_type='.($sort_field == 'district_name'? $sort_type : 0)+1) }}">
                        Kecamatan
                    </th>
            ...
            <tbody>
                ...
                @else
                    ...
                    <?php
                        ...
                        $coordinator_name[] = $data->user_name;
                        $dataByCoor[] = $total_data;
                        $total += $total_data;
                    ?>
                    <tr>
...
<script type="text/javascript">
    ...
    type: 'bar',
    data: {
        labels: {!! json_encode($coordinator_name) !!},
        datasets: [{
        label: "Rekap TPS",
